...
final class BrewStore: ObservableObject {
    ...
    @Published private(set) var taps: [BrewTap] = []
    @Published private(set) var searchResults: [BrewPackage] = []
    @Published private(set) var commandHistory: [BrewCommandResult] = []
    @Published private(set) var activeResult: BrewCommandResult?
    @Published var packageInfo: BrewPackageInfo?
